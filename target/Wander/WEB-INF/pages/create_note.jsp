...
%>
       ...
       <div class="container">
              ...
              <div class="login-form">
                     ...
                     style="font-size: 40px; color:#dc3545">Create a Note</h1>
                     ...
                     <button class="btn btn-primary"type="submit"style="width:100px;float:left">Home</button></form>
                           ...
                           <form id="notesubmit" action="notesubmit" method="post">
                     ...
                     style="font-size: 20px; color:#dc3545">Title :- </td><td><input type="text"size="35" name="title" required="required"><br></td></tr>

                           <tr><td class="form-heading"

                     style="font-size: 20px; color:#dc3545">Description :-</td><td style="size:1000px"> <input size="35" width="60"type="text" name="description" required="required"></td></tr>

                           </table>

                           <button class="btn btn-primary" style="width:300px" type="submit" name="Submit">Submit</button><br><br>
